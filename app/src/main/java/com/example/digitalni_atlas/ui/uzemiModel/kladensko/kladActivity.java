...
public class kladActivity extends AppCompatActivity {

    TabLayout tabLayout;
    ViewPager2 pager2;
    FragmentAdapter_klad adapter;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_klad);
        ...
        getSupportActionBar().setTitle("Kladensko");

        FragmentManager fm = getSupportFragmentManager();
        adapter = new FragmentAdapter_klad(fm, getLifecycle());
