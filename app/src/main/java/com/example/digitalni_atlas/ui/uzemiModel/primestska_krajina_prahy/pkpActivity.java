...
import com.example.digitalni_atlas.ui.uzemiModel.podboransko.FragmentAdapter_pod;
...
public class pkpActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getSupportActionBar().setTitle("Příměstská krajina Prahy");

        FragmentManager fm = getSupportFragmentManager();
        adapter = new FragmentAdapter_pkp(fm, getLifecycle());
