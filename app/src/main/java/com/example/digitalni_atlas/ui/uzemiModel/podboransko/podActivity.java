...
import com.example.digitalni_atlas.ui.uzemiModel.mostecko.FragmentAdapter_most;
...
public class podActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getSupportActionBar().setTitle("Podbořansko");

        FragmentManager fm = getSupportFragmentManager();
        adapter = new FragmentAdapter_pod(fm, getLifecycle());
