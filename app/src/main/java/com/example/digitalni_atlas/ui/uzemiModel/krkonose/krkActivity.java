...
import com.example.digitalni_atlas.ui.uzemiModel.kladensko.FragmentAdapter_klad;
...
public class krkActivity extends AppCompatActivity {

    TabLayout tabLayout;
    ViewPager2 pager2;
    FragmentAdapter_krk adapter;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_krk);
        ...
        getSupportActionBar().setTitle("Krkonoše");

        FragmentManager fm = getSupportFragmentManager();
        adapter = new FragmentAdapter_krk(fm, getLifecycle());
