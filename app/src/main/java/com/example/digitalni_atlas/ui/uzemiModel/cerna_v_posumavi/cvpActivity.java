...
import com.example.digitalni_atlas.ui.uzemiModel.kacina.FragmentAdapter_kach;
...
public class cvpActivity extends AppCompatActivity {

    TabLayout tabLayout;
    ViewPager2 pager2;
    FragmentAdapter_cvp adapter;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_cvp);
        ...
        getSupportActionBar().setTitle("Česká Kanada");

        FragmentManager fm = getSupportFragmentManager();
        adapter = new FragmentAdapter_cvp(fm, getLifecycle());
