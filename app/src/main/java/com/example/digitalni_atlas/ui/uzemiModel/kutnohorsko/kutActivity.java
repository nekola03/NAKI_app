...
import com.example.digitalni_atlas.ui.uzemiModel.krkonose.FragmentAdapter_krk;
...
public class kutActivity extends AppCompatActivity {

    TabLayout tabLayout;
    ViewPager2 pager2;
    FragmentAdapter_kut adapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getSupportActionBar().setDisplayHomeAsUpEnabled(true);
            ...
            getSupportActionBar().setTitle("Kutnohorsko");

            FragmentManager fm = getSupportFragmentManager();
            adapter = new FragmentAdapter_kut(fm, getLifecycle());
