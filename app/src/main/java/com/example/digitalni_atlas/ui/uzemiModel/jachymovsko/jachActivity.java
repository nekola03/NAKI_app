...
public class jachActivity extends AppCompatActivity {

    TabLayout tabLayout;
    ViewPager2 pager2;
    FragmentAdapter_jach adapter;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_jach);
        ...
        getSupportActionBar().setTitle("Jáchymovsko");

        FragmentManager fm = getSupportFragmentManager();
        adapter = new FragmentAdapter_jach(fm, getLifecycle());
