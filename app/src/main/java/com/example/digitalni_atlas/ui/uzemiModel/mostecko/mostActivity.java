...
import com.example.digitalni_atlas.ui.uzemiModel.kutnohorsko.FragmentAdapter_kut;
...
public class mostActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getSupportActionBar().setTitle("Mostecko");

        FragmentManager fm = getSupportFragmentManager();
        adapter = new FragmentAdapter_most(fm, getLifecycle());
